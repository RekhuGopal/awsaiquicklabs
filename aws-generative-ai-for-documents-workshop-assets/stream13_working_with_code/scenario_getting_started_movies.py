...
class Movies:
    ...
    # write a function to update_movies
    # it should take title, year, rating and plot arguments
    # snippet-start:[python.example_code.dynamodb.UpdateItem]
    

    # snippet-end:[python.example_code.dynamodb.UpdateItem]
